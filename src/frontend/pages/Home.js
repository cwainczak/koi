...
const Home = () => {
    return (
        <Container>
            ...
            <br/>
            <Post
                username="bawlintel" title="Letter wooded direct"
            ...
            <br/>
            <Post
                username="modifiedmicrosoft" title="Insipidity the sufficient discretion"
